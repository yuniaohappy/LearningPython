...
cluster = Cluster('localhost:2001','localhost:2002,localhost:2003','ps',0)
print(cluster.get_cluster())

# # 创建网络结构
# with tf.device(tf.train.replica_device_setter(worker_device='/job:ps/task:{task_index}'.format(cluster.task_index),
