...
cluster = Cluster('localhost:2001','localhost:2002,localhost:2003','worker',1)
server = cluster.get_cluster()


# 创建网络结构
with tf.device(tf.train.replica_device_setter(worker_device='/job:worker/task:%d' % cluster.task_index,
